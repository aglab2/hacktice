...
const u8 uCHECKPOINTS[] = { 0X1D, 0x12, 0x16, 0x0E, 0x1B, 0x9E, 0x0C, 0x11, 0x0E, 0x0C, 0x14, 0x19, 0x18, 0x12, 0x17, 0x1D, 0x1C, 0xFF };
...
const u8 uGENERAL[] = { 0X10, 0x0E, 0x17, 0x0E, 0x1B, 0x0A, 0x15, 0xFF };
